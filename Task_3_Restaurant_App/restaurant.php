...
<body>
    <div class="centerDiv">
        <?php if (empty($datas)) {
            ...
            echo "<a href='addComment.php?r_id=" . $restaurant_id . "'><button>Yorum Ekle</button></a></div>";
        } else { ?>
            ...
            <a href="addComment.php?r_id=<?php echo $restaurant_id; ?>"><button class="container_obj">Yorum Ekle</button></a>
